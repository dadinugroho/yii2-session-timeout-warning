...
namespace dadinugroho\sessionWarning\assets;
...
{
    public $sourcePath = '@dadinugroho/sessionWarning/assets/files';
    public $js = [
    ...
    {
        $options = array_merge([
            'message' => Yii::t('dadinugroho/sessionWarning', 'Your session is going to expire at {time}.')
        ], $options);
